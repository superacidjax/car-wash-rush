...
Profile version 5 stores quality charge on each Quality Sponge and persists whether the player placed their aircraft-yard ladder. The quality-charge migration assigns an old profile-wide charge to the equipped Quality Sponge, or the first one found.
